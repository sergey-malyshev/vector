...
#define RETARGET
		...
		#define RETARGET_UART_PORT GPIOC
		#define RETARGET_UART_PORT_EN RCU_HCLKCFG_GPIOCEN_Msk
		#define RETARGET_UART_PORT_AF ALTFUNCNUM1
		#define RETARGET_UART_PIN_TX_POS 15
		#define RETARGET_UART_PIN_RX_POS 14
		#define RETARGET_UART_PIN_TX_AFNUM (2 << 28)
		#define RETARGET_UART_PIN_RX_AFNUM (2 << 24)
